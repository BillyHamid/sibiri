      ...
      >
        <div className={`flex items-center justify-between gap-6 py-3 transition-all duration-200 ${scrolled ? 'lg:py-3' : 'lg:py-5'}`}>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              style={{ background: `linear-gradient(135deg, ${PRIMARY}, ${PRIMARY_LIGHT})`, color: 'white', fontFamily: "'Inter', sans-serif" }}
            >
              Contact
            </a>
          </div>
        ...
        {open && (
          <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} className="lg:hidden pb-6">
            ...
            <a href="#contact" className="inline-flex mt-4 text-sm font-semibold px-5 py-2.5 rounded-full" style={{ background: `linear-gradient(135deg, ${PRIMARY}, ${PRIMARY_LIGHT})`, color: 'white', fontFamily: "'Inter', sans-serif" }}>
              Contact
            </a>
          </motion.div>
        )}
